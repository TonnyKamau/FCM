...
def message_to_dict(doc_id, d):
    ...
    return {
        ...
        "timestamp":       timestamp,
        # ── Android special message-card types (MessageModel.java) ──────────
        "loanRequestModel":            d.get("loanRequestModel"),
        ...
        "memberWithdrawalReason":      d.get("memberWithdrawalReason", ""),
        "isMemberAccountTransactionCard": bool(d.get("isMemberAccountTransactionCard", False)),
        "memberAccountTransactionType":   d.get("memberAccountTransactionType", ""),
        "memberAccountTransactionAmount": float(d.get("memberAccountTransactionAmount", 0) or 0),
        "memberAccountMemberName":        d.get("memberAccountMemberName", ""),
        "isAiAnalysis":    bool(d.get("isAiAnalysis", False)),
        "aiAnalysisText":  d.get("aiAnalysisText", ""),
        "isAiReport":      bool(d.get("isAiReport", False)),
